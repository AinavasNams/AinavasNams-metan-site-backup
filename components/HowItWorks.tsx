      ...
      <div className="metan-container relative z-10">
        ...
        >
          ...
          <p className="text-xl text-metan-text max-w-2xl mx-auto">
            Īss kopsavilkums par mūsu darba procesu — no atkritumu savākšanas līdz biometāna ražošanai
          </p>
        </motion.div>
