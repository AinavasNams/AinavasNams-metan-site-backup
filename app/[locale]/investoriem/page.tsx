        ...
        <div className="metan-container text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <a href="mailto:tsv@metan.lv?subject=CH4 Future investīciju iespējas&body=Sveiki! Mani interesē CH4 Future projekta investīciju iespējas." style={{color: 'inherit', textDecoration: 'none', display: 'flex', alignItems: 'center'}}>
